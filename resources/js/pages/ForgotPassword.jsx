        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-16">
            ...
            <div>
              ...
              <p className="text-sm text-amber-200 font-light">Password Recovery</p>
            </div>
          </div>

          <div className="space-y-6 max-w-sm">
            <h2 className="text-4xl font-bold leading-tight">Reset your password securely by email.</h2>
        ...
        <div className="w-full max-w-md">
          <div className="flex items-center gap-3 mb-10 lg:hidden">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--color-brand-tan)]">Password Recovery</p>
            </div>
          </div>

          <div className="bg-white rounded-3xl shadow-xl p-10">
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-[var(--color-sys-text-primary)]">Forgot password</h2>
